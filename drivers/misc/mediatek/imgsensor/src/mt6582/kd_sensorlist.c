...
#include <linux/slab.h> /*Kernel 3.10*/
 ...
 * GPIO Defines
******************************************************************************/
/* Change to direct use GPIOXXX to set GPIO mode
// These defines should be defined in DCT tool -> from this header file: cust_gpio_usage.h
#ifndef GPIO_CMDAT0
#define GPIO_CMDAT0         (GPIO120 | 0x80000000)
#endif

#ifndef GPIO_CMDAT1
#define GPIO_CMDAT1         (GPIO121 | 0x80000000)
#endif
...
#ifndef GPIO_CMPCLK
#define GPIO_CMPCLK         (GPIO123 | 0x80000000)
#endif
    
#ifndef GPIO_CAMERA_RDP0_A
#define GPIO_CAMERA_RDP0_A         (GPIO141 | 0x80000000)
#endif

#ifndef GPIO_CAMERA_RDN0_A    
#define GPIO_CAMERA_RDN0_A         (GPIO142 | 0x80000000)
#endif


#ifndef GPIO_CAMERA_RDP1_A    
#define GPIO_CAMERA_RDP1_A         (GPIO143 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RDN1_A
#define GPIO_CAMERA_RDN1_A         (GPIO144 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RCP_A
#define GPIO_CAMERA_RCP_A         (GPIO145 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RCN_A
#define GPIO_CAMERA_RCN_A         (GPIO146 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RDP0
#define GPIO_CAMERA_RDP0         (GPIO147 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RDN0
#define GPIO_CAMERA_RDN0         (GPIO148 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RDP1
#define GPIO_CAMERA_RDP1         (GPIO149 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RDN1
#define GPIO_CAMERA_RDN1         (GPIO150 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RCP
#define GPIO_CAMERA_RCP         (GPIO151 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RCN
#define GPIO_CAMERA_RCN         (GPIO152 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RDP2
#define GPIO_CAMERA_RDP2         (GPIO153 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RDN2
#define GPIO_CAMERA_RDN2         (GPIO154 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RDP3
#define GPIO_CAMERA_RDP3         (GPIO155 | 0x80000000)
#endif

    
#ifndef GPIO_CAMERA_RDN3
#define GPIO_CAMERA_RDN3         (GPIO156 | 0x80000000)
#endif
*/
...
{        
    ...
    for ( i = KDIMGSENSOR_INVOKE_DRIVER_0 ; i < KDIMGSENSOR_MAX_INVOKE_DRIVERS ; i++ ) {
        if ( g_bEnableDriver[i] && g_pInvokeSensorFunc[i] ) {
            if(DUAL_CAMERA_MAIN_SENSOR==g_invokeSocketIdx[i]){
				access_ret = access_ok(VERIFY_WRITE, (void __user *)pSensorResolution[0], sizeof(MSDK_SENSOR_RESOLUTION_INFO_STRUCT));
				if(access_ret == 0)
				{ 
					PK_ERR("kd_MultiSensorGetResolution access_ok pSensorResolution[0] return failed!\n");
					return ERROR_INVALID_PARA;
				} 
                ret = g_pInvokeSensorFunc[i]->SensorGetResolution(pSensorResolution[0]);
            }
            else if(DUAL_CAMERA_SUB_SENSOR==g_invokeSocketIdx[i]) {
				access_ret = access_ok(VERIFY_WRITE, (void __user *)pSensorResolution[1], sizeof(MSDK_SENSOR_RESOLUTION_INFO_STRUCT));
				if(access_ret == 0)
				{
					PK_ERR("kd_MultiSensorGetResolution access_ok pSensorResolution[1] return failed!\n");
					return ERROR_INVALID_PARA;
				}
